...
for win = 200 % 50:50:1150 %1000 %  350:50:450
    increment = 20; % win; % win; % 1000 ; % for removal of increment algorithm, make incremment = to win
for TOE = 3 % [1,3] %1 % 3 %  [1,3] % for isolated gait events 
% win_scheme = 20;    
for win_scheme = 20 % 1 % [0,1] % 20  %  0:1;
% for Toe =  1,2
...
for TOE = 3  % [1,3] % TOE % [1,3] %   TOE %  TOE %  [1,3] % 1:2 % Toe
        if TOE == 1
           toe = [];
